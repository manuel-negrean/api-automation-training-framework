...
public class TestDataFactory {
    public static PetDto createPet(long id, String petName, PetDto.CategoryDto categoryName,
                                   PetDto.TagDto petTag, String petStatus) {
    ...
    public static StoreOrderDto createOrder (long id, long petID, int quantity, String shipDate,
